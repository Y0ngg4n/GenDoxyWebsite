...
<body>
<?php
echo "<a class='docNavElem' href='index.php'>Projekte</a> > ";
echo "<a class='docNavElem' href='projects.php?docPath=${realDocPath}&project=${project}'>${project}</a> > ";
echo "<a class='docNavElem' href='branches.php?docPath=${realDocPath}/${project}&repo=${repo}&project=${project}'>${repo}</a><br>";
